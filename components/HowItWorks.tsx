  ...
  return (
    <section className="px-8 py-32 max-w-[1400px] mx-auto w-full">
      ...
      <div className="relative">
        ...
        <div className="hidden lg:block absolute top-[4.5rem] left-[12.5%] right-[12.5%] h-px border-t border-dashed border-white/10 z-0" />
            ...
            return (
              <div key={step.number} className="elite-card p-8 space-y-6 group">
                ...
                <div className="flex items-start justify-between">
                  <span className="font-bungee text-6xl leading-none text-white/10 select-none">
                    {String(step.number).padStart(2, "0")}
                  </span>
                  <div className="w-12 h-12 bg-magenta/10 rounded-2xl flex items-center justify-center border border-magenta/20 shadow-[0_0_20px_rgba(233,30,99,0.1)] flex-shrink-0">
      ...
      <div className="text-center mt-16">
        <a
          ...
          className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-[0.2em] text-white/40 hover:text-white transition-colors duration-200"
        >
